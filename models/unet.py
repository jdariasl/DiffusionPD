...
class UNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, num_classes=4, init_features=32, time_emb_dim=128):
        ...
        self.encoder1 = UNetBlock(in_channels + 1, features, init_features, time_emb_dim)
        self.pool1 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.encoder2 = UNetBlock(features, features * 2, init_features, time_emb_dim)
        self.pool2 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.encoder3 = UNetBlock(features * 2, features * 4, init_features, time_emb_dim)
        self.pool3 = nn.MaxPool1d(kernel_size=2, stride=2)
        self.encoder4 = UNetBlock(features * 4, features * 8, init_features, time_emb_dim)
        ...
        self.decoder4 = UNetBlock(features * 16, features * 8, init_features, time_emb_dim)
        self.upconv3 = nn.ConvTranspose1d(features * 8, features * 4, kernel_size=2, stride=2)
        self.decoder3 = UNetBlock(features * 8, features * 4, init_features, time_emb_dim)
        self.upconv2 = nn.ConvTranspose1d(features * 4, features * 2, kernel_size=2, stride=2)
        self.decoder2 = UNetBlock(features * 4, features * 2, init_features, time_emb_dim)
    ...
    def forward(self, x, class_label, time_step):
        ...
        bottleneck, enc1, enc2, enc3, enc4, class_embeb, time_emb = self.encode(x, class_label, time_step)
