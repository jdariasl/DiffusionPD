...
class UNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, num_classes=10, init_features=32):
        super(UNet, self).__init__()
        
        self.num_classes = num_classes
        features = init_features
        self.encoder1 = UNet._block(in_channels + num_classes, features, name="enc1")
    ...
    def forward(self, x, class_label):
        ...
        class_onehot = class_onehot.view(class_onehot.size(0), self.num_classes, 1, 1)
